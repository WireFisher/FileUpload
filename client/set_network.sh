...
#sudo tc qdisc add dev eth0 root handle 1:0 netem delay 150ms 70ms distribution normal loss 50%
#sudo tc qdisc add dev eth0 parent 1:1 handle 10: tbf rate 100kbit buffer 1600 limit 3000
...
sudo tc qdisc add dev lo root handle 1:0 netem delay 150ms 70ms distribution normal
...
#sudo tc qdisc add dev lo root tbf rate 1mbit burst 10kb latency 70ms peakrate 2mbit minburst 1540
